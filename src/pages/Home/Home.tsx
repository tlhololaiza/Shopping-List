    ...
    <div className="home-container">
      {isAuthenticated ? (
        <>
          ...
          <p>
            To begin, click on the **Shopping Lists** link in the navigation bar to create and manage your lists.
          </p>
        </>
      ) : (
        <>
          ...
          <p>
            ...
            You can add items with details like quantity, notes, category, and even images.
          </p>
          <p>
